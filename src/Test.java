...
import static java.lang.System.out;//למחוק אחכ
...
interface Constants
{
    ...
    public static void main(String[] args) throws IOException {
        //DataOutputStream outStream = new DataOutputStream(out);//להחזיר אח''כ
        DataOutputStream outStream = new DataOutputStream(new FileOutputStream("my_output.txt"));////למחוק אחכ
        ...
        //testMedianDS(random, outStream);//להחזיר אח''כ
    }
    public static void testMinHeap(Random random, DataOutputStream outStream) throws IOException
    {
        ...
        //outStream.writeBytes("It's a test" + System.lineSeparator());//למחוק אח''כ
        //heap.printByLayer(outStream);//למחוק אח''כ
